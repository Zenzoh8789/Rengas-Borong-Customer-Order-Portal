      ...
      <form className="auth-card auth-login-card" onSubmit={submitHandler}>
        ...
        {mode === "forgot-otp" && developmentOtp && (
          <p className="auth-note" role="status">
            Development only — no SMS was sent. Your reset code:{" "}
        ...
        {mode === "forgot-password" && (
          <p className="auth-note">
            Use at least 8 characters. Submit within 10 minutes of verification.
            If expired, go back and request a new code.
          </p>
        )}

        {(mode === "login" || mode === "otp") && (
          <p className="auth-switch">
            New to Renga Borong? <Link to="/signup">Create an account</Link>
          </p>
        )}
      </form>
    </main>
